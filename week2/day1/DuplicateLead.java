...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		System.out.println("Create Lead Page status: "+title);
		driver.findElement(By.partialLinkText("Duplicate Lead")).click();
		driver.findElement(By.id("createLeadForm_companyName")).clear();
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("CTS");
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Gandhish");
		driver.findElement(By.className("smallSubmit")).click();
		String titles = driver.getTitle();
		System.out.println("Duplicate Lead Page status: "+titles);
